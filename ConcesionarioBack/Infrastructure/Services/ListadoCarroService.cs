...
{
    public class ListadoCarroService : ICommonService<ListadoDto>
    {
        private ConcesionarioContext _context;

        public ListadoCarroService(ConcesionarioContext context)
        {
            _context = context;
        }
        ...
        {
            var listado = await _context.ListadoCarros.FindAsync(listadoId);
            ...
            _context.ListadoCarros.Remove(listado);
            await _context.SaveChangesAsync();
        ...
        public async Task<IEnumerable<ListadoDto>> Get()=>
            await _context.ListadoCarros.Select(l => new ListadoDto
            {
                Id = l.ListaCarroId,
                Modelo = l.Modelo,
                Precio = l.Precio
        ...
        {
            var listado = await _context.ListadoCarros.FindAsync(id);
